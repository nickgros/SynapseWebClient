...
public class ProfileViewImpl extends Composite implements ProfileView {
   ...
   */
  @Override
  public void setTabSelected(ProfileArea targetTab) {
    // tell presenter what tab we're on only if the user clicked
    if (targetTab == null) targetTab = ProfileArea.PROFILE; // select tab, set default if needed
    hideTabContainers();
    this.currentTab = targetTab;

    if (targetTab == ProfileArea.PROFILE) {
      pageHeaderTitle.setText(profileHeaderText);
      orientationBannerPanel.clear();
      DisplayUtils.show(profileTabContainer);
    } else if (targetTab == ProfileArea.PROJECTS) {
    ...
    } else if (targetTab == ProfileArea.TEAMS) {
    ...
    } else if (targetTab == ProfileArea.SETTINGS) {
      pageHeaderTitle.setText("Account Settings");
      orientationBannerPanel.clear();
      DisplayUtils.show(settingsTabContainer);
    } else if (targetTab == ProfileArea.CHALLENGES) {
    ...
    } else if (targetTab == ProfileArea.FAVORITES) {
