...
public class ProvenanceWidget
  ...
  private Map<String, ProvGraphNode> idToNode =
    new HashMap<String, ProvGraphNode>();
  ...
  public void configure(
    ...
    // (if Versionable)
    AsyncCallback<Void> lookupCurrentVersionCallback =
      new AsyncCallback<Void>() {
        @Override
        public void onSuccess(Void result) {
          // load stack with starting nodes at depth 0
          toProcess = new Stack<ProcessItem>();
    ...
    jsClient.getEntityHeaderBatchFromReferences(
      ...
      new AsyncCallback<ArrayList<EntityHeader>>() {
        ...
        public void onSuccess(ArrayList<EntityHeader> currentVersions) {
          Map<String, Long> entityToCurrentVersion =
