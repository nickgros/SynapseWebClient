...
import org.sagebionetworks.web.shared.table.TableType;
...
public class ColumnModelsEditorWidget
  ...
  private ColumnModelTableRowEditorWidget createColumnModelEditorWidget(
    ...
    ColumnModelTableRowEditorWidget rowEditor =
      ginInjector.createColumnModelEditorWidget();
  ...
  public void addColumns(List<ColumnModel> models) {
    ...
    Map<ColumnModelKey, ColumnModel> newModels =
      new HashMap<ColumnModelKey, ColumnModel>();
  ...
  public boolean validate() {
    ...
    for (ColumnModelTableRow editor : editorRows) {
      if (editor instanceof ColumnModelTableRowEditorWidget) {
        ColumnModelTableRowEditorWidget widget =
