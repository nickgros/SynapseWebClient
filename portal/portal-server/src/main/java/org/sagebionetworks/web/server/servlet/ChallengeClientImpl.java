...
import org.sagebionetworks.web.shared.ChallengeClient;
...
public class ChallengeClientImpl
  ...
  public static List<Evaluation> getShareableEvaluations(
    ...
    org.sagebionetworks.reflection.model.PaginatedResults<Evaluation> allEvaluations =
      synapseClient.getEvaluationByContentSource(
        entityId,
  ...
  public ChallengeTeamPagedResults getChallengeTeams(
    ...
    try {
      ...
      List<ChallengeTeamBundle> challengeTeamList =
        new ArrayList<ChallengeTeamBundle>();
