...
public class SynapseClientImplTest {
  ...
  EntityPath path;
  PaginatedResults<UserGroup> pgugs;
  PaginatedResults<UserProfile> pgups;
  PaginatedResults<Team> pguts;
  Team teamA, teamZ;
  ...
  public void before() throws SynapseException, JSONObjectAdapterException {
    ...
    pgugs = new PaginatedResults<UserGroup>();
    ...
    pgups = new PaginatedResults<UserProfile>();
    ...
    pguts = new PaginatedResults<Team>();
    ...
    PaginatedResults<EntityHeader> batchHeaders =
    ...
    PaginatedResults<AccessRequirement> ars =
  ...
  public void testIsChallenge() throws RestServiceException, SynapseException {
    ...
    PaginatedResults<Evaluation> testResults =
      new PaginatedResults<Evaluation>();
    ...
    testResults = new PaginatedResults<Evaluation>();
